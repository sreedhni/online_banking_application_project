...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Customer', '0016_remove_transaction_upi_pin_openaccount_upi_pin'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Customer.loanapply')),
            ],
        ),
    ]
